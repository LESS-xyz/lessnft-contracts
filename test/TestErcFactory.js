...
contract(
    ...
    ([
        ...
        beforeEach(async () => {
            ...
            expect(await ExchangeInst.SIGNER_ROLE()).to.be.equals(SIGNER_ROLE);
        ...
        it("#4 Test exchange ERC721", async () => {
            ...
            await expectRevert(
                ExchangeInst.makeExchangeERC721(
                    ...
                    { tokenAddress: ERC20TestInst.address, id: ZERO, amount: ONE_TOKEN },
                    feeAddresses,
                    feeAmount,
                    signature,
                    { from: user2 }
            ...
            await expectRevert(
                ExchangeInst.makeExchangeERC721(
                    orderId,
                    user1,
                    { tokenAddress: ERC721MainInst.address, id: ONE, amount: ZERO },
                    { tokenAddress: ERC20TestInst.address, id: ZERO, amount: ONE_TOKEN },
                    feeAddresses,
                    feeAmount,
                    signature,
            ...
            await expectRevert(
                ExchangeInst.makeExchangeERC721(
                    ...
                    user1,
                    { tokenAddress: ERC721MainInst.address, id: ZERO, amount: ZERO },
                    { tokenAddress: ZERO_ADDRESS, id: ZERO, amount: ONE_TOKEN },
                    feeAddresses,
                    feeAmount,
                    signature,
                    { from: user2 }
            ...
            await expectRevert(
                ExchangeInst.makeExchangeERC721(
                    ...
                    user1,
                    { tokenAddress: ERC721MainInst.address, id: ZERO, amount: ZERO },
                    { tokenAddress: ERC20TestInst.address, id: ZERO, amount: ONE_TOKEN.div(TWO) },
                    feeAddresses,
                    feeAmount,
                    signature,
                    { from: user2 }
        ...
        it("#5 Test exchange ERC1155", async () => {
            ...
            await expectRevert(
                ExchangeInst.makeExchangeERC1155(
                    invalidOrderId,
                    user1,
                    ERC721MainInst.address,
                    ZERO,
                    TEN,
                    ERC20TestInst.address,
                    ONE_TOKEN,
                    feeAddresses,
                    feeAmount,
                    signature,
